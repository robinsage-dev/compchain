...
All other packaging related files can be found in the [compchain-core/packaging](https://github.com/bitcoin-core/packaging) repository.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Compchain Core documentation repository](https://github.com/bitcoin-core/docs).

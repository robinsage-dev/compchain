// Copyright (c) 2013-2018 The Compchain Core developers
...
public:
    CMainParams() {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,170); // S
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,223); // a

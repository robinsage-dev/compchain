...
#ifndef COMPCHAIN_QT_COMPCHAINUNITS_H
#define COMPCHAIN_QT_COMPCHAINUNITS_H
...
/** Compchain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CompchainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CompchainUnits(QObject *parent);

    /** Compchain units.
      @note Source: https://en.compchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef CompchainUnits::Unit CompchainUnit;

#endif // COMPCHAIN_QT_COMPCHAINUNITS_H

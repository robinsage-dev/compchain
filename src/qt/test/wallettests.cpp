...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CompchainAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_compchain-qt -platform xcb      # Linux
//     src/qt/test/test_compchain-qt -platform windows  # Windows
//     src/qt/test/test_compchain-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CompchainUnits::formatWithUnit(unit, balance, false, CompchainUnits::separatorAlways);
    ...
    // Amount input
    CompchainAmountField* amountInput = receiveCoinsDialog.findChild<CompchainAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: compchain:")) != -1);

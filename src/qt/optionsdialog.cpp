    ...
    mapper(0)
{
    ...
    ui->compchainAtStartup->setToolTip(ui->compchainAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->compchainAtStartup->setText(ui->compchainAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openCompchainConfButton->setToolTip(ui->openCompchainConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CompchainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->compchainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCompchainConfButton_clicked()
{

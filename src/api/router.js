...
function initApiRouter() {
    ...
    // // TODO: get block template for miner (accessed at GET http://localhost:8080/api/blocks/template)
    // .get(function (req, res) {
    ...
    // get all the transactions (accessed at GET http://localhost:8080/api/tx)
        .get(function (req, res) {
    ...
    router.route('/tx/:tx_hash');
    // get the block with that hash (accessed at GET http://localhost:8080/api/tx/:tx_hash)
    // .get(function(req, res) {
    //     Transaction.find(req.params.tx_hash, function(err, tx) {
    //         if (err)
    //             res.send(err);
    //         res.json(tx);
    //     });

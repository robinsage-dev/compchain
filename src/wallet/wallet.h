...
#ifndef COMPCHAIN_WALLET_WALLET_H
#define COMPCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this compchain node, and set to 0 for transactions that were created
...
#endif // COMPCHAIN_WALLET_WALLET_H

...
#ifndef COMPCHAIN_TEST_SCRIPTNUM10_H
#define COMPCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Compchain Core 0.10.0, for cross-comparison.
 */
public:

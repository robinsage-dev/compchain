...
#ifndef COMPCHAIN_SCRIPT_STANDARD_H
#define COMPCHAIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a compchain address
 */
...
/**
 * Generate a Compchain scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // COMPCHAIN_SCRIPT_STANDARD_H

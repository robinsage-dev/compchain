...
static void SetupCompchainTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " compchain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  compchain-tx [options] <hex-tx> [commands]  Update hex-encoded compchain transaction\n" +
            "or:     compchain-tx [options] -create [commands]   Create hex-encoded compchain transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded compchain transaction

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s compchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  compchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded compchain transaction") + "\n" +
              "  compchain-tx [options] -create [commands]   " + _("Create hex-encoded compchain transaction") + "\n" +
              "\n";

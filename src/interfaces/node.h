...
#ifndef COMPCHAIN_INTERFACES_NODE_H
#define COMPCHAIN_INTERFACES_NODE_H
...
//! Top-level interface for a compchain node (compchaind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // COMPCHAIN_INTERFACES_NODE_H

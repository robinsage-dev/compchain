...
#ifndef COMPCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define COMPCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // COMPCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

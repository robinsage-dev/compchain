...
# TestNode: A peer we use to send messages to compchaind, and store responses.
...
class CompactBlocksTest(CompchainTestFramework):
    ...
    # This test actually causes compchaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that compchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for compchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # compchaind will not send blocktxn responses for blocks whose height is

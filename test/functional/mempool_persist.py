...
By default, compchaind will dump mempool on shutdown and
...
class MempoolPersistTest(CompchainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give compchaind a second to reload the mempool
        ...
        self.log.debug("Prevent compchaind from writing mempool.dat to disk. Verify that `savemempool` fails")

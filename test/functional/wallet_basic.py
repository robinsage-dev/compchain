...
class WalletTest(CompchainTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 COCO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 COCO with subtract fee from amount
        ...
        # Sendmany 10 COCO with subtract fee from amount

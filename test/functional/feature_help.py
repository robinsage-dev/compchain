...
"""Verify that starting compchain with -h works as expected."""

from test_framework.test_framework import CompchainTestFramework
from test_framework.util import assert_equal

class HelpTest(CompchainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start compchain with -h for help text")
        ...
        self.log.info("Start compchain with -version for version information")
        ...
        self.log.info("Start compchaind with -fakearg to make sure it does not start")

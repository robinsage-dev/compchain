...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/compchain/compchain/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/compchain/compchain/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/compchain/compchain/pull/7415) for an example.
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/compchain/compchain.git
...
### Build and sign Compchain Core for Linux, Windows, and OS X:
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`compchain-${VERSION}-osx-unsigned.dmg`, `compchain-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import compchain/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer compchain-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [compchain-detached-sigs](https://github.com/compchain-core/compchain-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Update compchain.org version
  ...
  - First, check to see if the Compchain.org maintainers have prepared a
    release: https://github.com/compchain-dot-org/compchain.org/labels/Releases
  ...
  - If they have not prepared a release, follow the Compchain.org release
    instructions: https://github.com/compchain-dot-org/compchain.org#release-notes
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/compchain/compchain/releases/new) with a link to the archived release notes.

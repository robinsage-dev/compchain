...
* compchain.conf: contains configuration settings for compchaind or compchain-qt
* compchaind.pid: stores the process id of compchaind while running
...
* debug.log: contains debug information and general logging generated by compchaind or compchain-qt

Compchain version 0.6.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Compchain/bitcoin-0.6.0/test/
...
versions of Compchain-Qt/bitcoind.
...
bitcoin: URIs onto the Compchain-Qt window to start
payment.

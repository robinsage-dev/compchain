Compchain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/compchain/files/Compchain/compchain-0.5.4/
...
http://gitorious.org/compchain/compchaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Compchain-Qt notifications under Growl 1.3.
Increase required age of Compchain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCompchain properly when installing Compchain-Qt over it. (Windows)

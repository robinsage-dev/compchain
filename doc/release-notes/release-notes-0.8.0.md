Compchain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/compchain/files/Compchain/compchain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Compchain
...
New/changed settings (command-line or compchain.conf file)
--------------------------------------------------------

...
over /Applications/Compchain-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).
...
0.1mCOCO per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mCOCO per kilobyte

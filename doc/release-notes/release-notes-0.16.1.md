Compchain Core version 0.16.1 is now available from:

  <https://compchaincore.org/bin/compchain-core-0.16.1/>
...
- #12843 `df38b13` Test starting compchaind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure compchaind processes are cleaned up when tests end (sdaftuar)

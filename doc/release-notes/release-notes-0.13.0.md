...
randomly crashing on Windows XP. It is [not clear](https://github.com/compchain/compchain/issues/7681#issuecomment-217439891)
...
Various code modernizations have been done. The Compchain Core code base has
...
compatible peers.
[BIP 152](https://github.com/compchain/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/compchain/compchain/pull/8035/files), [BIP 32](https://github.com/compchain/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/compchain/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/compchain/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/compchain/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/compchain/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Compchain Core is expected that
...
Witness)] (https://github.com/compchain/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/compchain/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the Compchain-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/compchain/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/compchain/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/compchain/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/compchain/compchain/pull/7762).
...
- #8164 `0f24eaf` [Compchain-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)

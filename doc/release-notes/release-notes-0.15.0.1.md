Compchain Core version *0.15.0.1* is now available from:

  <https://compchain.org/bin/compchain-core-0.15.0.1/>

and

  <https://compchaincore.org/bin/compchain-core-0.15.0.1/>

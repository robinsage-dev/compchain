Compchain Core version 0.13.2 is now available from:

  <https://compchain.org/bin/compchain-core-0.13.2/>
...
- #8908 `4a974b2` Update compchain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow compchain-tx to create v2 transactions (btcdrak)

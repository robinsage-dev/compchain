Compchain Core version 0.10.4 is now available from:

  <https://compchain.org/bin/compchain-core-0.10.4/>
...
- #6953 `43c2789` Split compchain-tx into its own package
- #6953 `dfe0d4d` Include compchain-tx binary on Debian/Ubuntu
